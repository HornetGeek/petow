...
pets_data = [
    {
        ...
        'health_status': 'تم تطعيمها بالكامل - آخر فحص في 2024-01-15',
        'temperament': 'هادئة ومحبة',
        'location': 'الرياض',
        'is_free': True,
    ...
    },
    {
        ...
        'health_status': 'صحة ممتازة - جميع التطعيمات محدثة',
        'temperament': 'نشيط ومحب للعب',
        'location': 'جدة',
        'breeding_fee': 500.00,
        'is_trained': True,
    ...
    },
    {
        ...
        'health_status': 'صحة جيدة - فحص دوري منتظم',
        'temperament': 'ذكي ومتفاعل',
        'location': 'الدمام',
